...
var init_jsbi = __esm({
  "node_modules/jsbi/dist/jsbi.mjs"() {
    JSBI = class _JSBI extends Array {
      constructor(i, _) {
        if (super(i), this.sign = _, Object.setPrototypeOf(this, _JSBI.prototype), i > _JSBI.__kMaxLength)
      ...
      static __toStringBasePowerOfTwo(_, i) {
        ...
        const h = (u | s << d) & g;
        for (r[a--] = _JSBI.__kConversionChars[h], u = s >>> n - d; 0 !== u; )
...
//# sourceMappingURL=chunk-4TVIYKVB.js.map
